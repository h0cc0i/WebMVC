...
namespace WebMVC.COMMON
{
    public static class Helpers
    {
        ...
        public static void CopyObject<T>(object sourceObject, ref T destObject,List<string> lstExept)
        {
    ...
    public class CustomViewLocationRazorViewEngine : RazorViewEngine
    {
        public CustomViewLocationRazorViewEngine()
        {
            ...
            ViewLocationFormats = new[] { 
                ...
                "~/Views/GSP_Tracking/{1}/{0}.cshtml","~/Views/GSP_Tracking/{1}/{0}.vbhtml",   // them moi location danh muc
                ...
                "~/Views/GPS_DanhMuc/{1}/{0}.cshtml","~/Views/GPS_DanhMuc/{1}/{0}.cshtml" //them location Danh mục
            ...
            PartialViewLocationFormats = new[] { 
                ...
                "~/Views/NuoiTrong/{1}/{0}.cshtml","~/Views/NuoiTrong/{1}/{0}.vbhtml",   // them moi location nuoi trong
                "~/Views/REPORTS/{1}/{0}.cshtml","~/Views/REPORTS/{1}/{0}.vbhtml",   // them moi location reports
                "~/Views/GPS_DanhMuc/{1}/{0}.cshtml","~/Views/GPS_DanhMuc/{1}/{0}.cshtml" 
